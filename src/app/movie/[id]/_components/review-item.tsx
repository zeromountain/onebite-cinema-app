  ...
  return (
    <li className="bg-black rounded-lg p-4 shadow-md">
      <div className="flex justify-end gap-2">
        <button className="text-sm text-gray-400 border border-gray-400 rounded-md px-2 py-1 hover:bg-gray-400 hover:text-white active:bg-gray-400 active:bg-gray-500">
          ✍️ 수정하기
        </button>
        <button className="text-sm text-gray-400 border border-gray-400 rounded-md px-2 py-1 hover:bg-gray-400 hover:text-white active:bg-gray-400 active:bg-gray-500">
          🗑️ 삭제하기
